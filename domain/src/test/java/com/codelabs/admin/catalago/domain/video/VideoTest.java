...
public class VideoTest {
    ...
    public void givenValidParams_whenCallsNewVideo_shouldInstantiate() {
        // given
        final var expectedTitle = "Titulo de exemplo";
        final var expectedDescription = """
                Análise do filme que considera a atuação, a direção, a cinematografia, a edição,
                 a trilha sonora e como esses elementos contribuem para o todo
                """;
    ...
    public void givenValidVideo_whenCallsSetBanner_shouldReturnUpdated() throws InterruptedException {
        ...
        // when
        final var actualVideo = Video.with(video).setBanner(bannerMedia);
        ...
        Assertions.assertTrue(actualVideo.getVideo().isEmpty());
        Assertions.assertTrue(actualVideo.getTrailer().isEmpty());
        Assertions.assertEquals(bannerMedia, actualVideo.getBanner().get());
        Assertions.assertTrue(actualVideo.getThumbnail().isEmpty());
        Assertions.assertTrue(actualVideo.getThumbnailHalf().isEmpty());

package com.codelabs.admin.catalago.e2e.genre;
...
public class GenreE2ETest implements MockDsl {
    ...
    public void asACatalogAdminIShouldBeAbleToSeeATreatedErrorByGettingANotFoundGenre() throws Exception {
        ...
        final var request = get("/genres/82906b9a-71f4-4388-ad8c-b14d5772a598")
                .accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON);

        this.mvc.perform(request)
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.message", equalTo("Genre not found in database with id 82906b9a-71f4-4388-ad8c-b14d5772a598")));
    }
    ...
    public void asACatalogAdminIShouldBeAbleToUpdateAGenreByItsIdentifier() throws Exception {
        ...
        final var requestBody = new GenreRequest(
                expectedName,
                mapTo(expectedCategories, CategoryID::getValue),
                expectedIsActive
        );

        updateAGenre(actualId, requestBody)
                .andExpect(status().isOk());
    ...
    public void asACatalogAdminIShouldNotSeeAnErrorByDeletingANotExistentGenre() throws Exception {
        ...
        deleteAGenre(GenreID.from("82906b9a-71f4-4388-ad8c-b14d5772a598"))
                .andExpect(status().isNoContent());
